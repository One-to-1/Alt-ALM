...
## Corpus Check
- 105 files · ~197,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1015 nodes · 1075 edges · 62 communities (41 shown, 21 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0c88930e`
...
Cohesion: 0.14
Nodes (23): Automation Tab: On-Failure & Notification Rules, Continue Manual Run Action, Wave 2 Agent 3: Test Lab + Test Runs UI Inventory, Manual Runner Deep-Dive, Execution Flow View, Execution Grid, Execution-Model ADR (REST-only Manual Runner Feasibility), Host Manager, Link Defect to Run/Step (+15 more)
...
Cohesion: 0.07
Nodes (38): Add Requirement Traceability, Add to Coverage Action, Alerts and Follow-up Flags, Baseline Capture/Compare, Business Models Linkage (Requirements), Configure Traceability Matrix Wizard, Convert to Tests Wizard, Coverage Analysis View (+30 more)
...
Cohesion: 0.33
Nodes (5): ADR 0003 — OTA/COM fallback isolated in an optional Windows sidecar, Alternatives considered, Consequences, Context, Decision
...
Cohesion: 0.29
Nodes (6): 1. Safety rules (non-negotiable), 2. Masking discipline, 3. Reusable script skeleton, 4. PowerShell gotchas found the hard way, 5. Probe protocol, 6. Currently open experiments
...
## Knowledge Gaps
- **705 isolated node(s):** `1. Load-bearing hazards (read this before writing any code)`, `2. Auth handshake`, `3. Envelopes`, `4. Query grammar cheat-sheet (Core, `/qcbin/rest/...`)`, `5. Bulk operations` (+700 more)
